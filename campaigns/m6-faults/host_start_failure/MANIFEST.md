# `host_start_failure` - capture manifest
...
```cmd
python tools\m6-checks\campaign_manifest.py campaigns\m6-faults\host_start_failure > campaigns\m6-faults\host_start_failure\MANIFEST.md
```
...
|---|---|---|---|---:|---:|---:|---|---|---|
| 000 | - | completed | `capture-atacama-air-defense-000.n8rocap.jsonl` | 6194615 | 12879 | 2 | yes | yes | `ff5fa848d8c3a17fae859bd70582b1fb89f3a7e4fe4f7625684a81c32d5e255d` |
...
| 002 | - | fail | `capture-atacama-air-defense-002.n8rocap.jsonl` | 6193745 | 12877 | 2 | yes | yes | `eb0cc8dfad9ac51e6dd36c5b208d8aba75f04b528409528e3f99b5e7de6b45f4` |

**4 capture(s), 24747770 bytes (24.7 MB) not committed.**
