# `scenario_load_refusal` - capture manifest
...
25 MB. `.gitignore` has excluded them since the repository was created, with the
...
```cmd
python tools\m6-checks\campaign_manifest.py campaigns\m6-faults\scenario_load_refusal > campaigns\m6-faults\scenario_load_refusal\MANIFEST.md
```
...
|---|---|---|---|---:|---:|---:|---|---|---|
| 000 | - | completed | `capture-atacama-air-defense-000.n8rocap.jsonl` | 6198214 | 12887 | 2 | yes | yes | `2666b9028af57f7bee99bfc83947216c1d040c8dfc33fdc07a48f02a695ce252` |
...
| run | value | outcome | capture | bytes | samples | segs | conformant | covers run | sha256 |
|---|---|---|---|---:|---:|---:|---|---|---|
| 000 | - | fail | `capture-atacama-air-defense-000.n8rocap.jsonl` | 6191505 | 12872 | 2 | yes | yes | `eed52492cc9ffd4f996433edbc32c45c3e1099057ba52c616f79ea4e7c99b8bf` |
| 001 | - | infrastructure_error | `capture-unknown-001.n8rocap.jsonl` | 1745 | 0 | 0 | yes | yes | `be2a56e97b4627f96030b6f54a1d8e2dcf1a687ec09341ed33b9484075b3f3da` |
| 002 | - | fail | `capture-atacama-air-defense-002.n8rocap.jsonl` | 6182703 | 12852 | 2 | yes | yes | `60a5610a269e59028ecbc17f51a08271507363d2d3a0deb13f8010f970fefe66` |

**5 capture(s), 24753872 bytes (24.8 MB) not committed.**
