...
**Date:** 2026-08-31
**Revision:** 5 — **OQ-4 resolved on measurement**, and the axis it chose carries a named cost rather than a clean bill. CR-PAR-1 and CR-PAR-2 delivered; two new risks (R13, R14); the fidelity ceiling recorded as a limit of the axis rather than of the tool; R12 extended with a parameterised rate. No requirement removed. See §"Revision history".
**Status:** Draft
