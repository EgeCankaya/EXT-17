...
**Date:** 2026-08-31
**Revision:** 4 — M4's gate delivered without the ruling it was gated on, and its cost recorded rather than absorbed. H1 validated at 190 pairs; one new risk (R12); R11 re-rated on a second instance; OQ-2's missed decision target recorded and re-targeted; two escalations sent. No requirement removed. See §"Revision history".
**Status:** Draft
