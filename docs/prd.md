...
| Mentor confirmation of the headless invocation (OQ-3) | Mentor | **Partly ANSWERED 2026-09-01** - (b), (d), (e), (f) confirmed; (a) and (c) not covered and still decided rather than answered | Did not block, and did not change anything: every confirmed answer matched what was already built. (b) additionally makes F-17 firm enough to raise upstream as E-6 |
